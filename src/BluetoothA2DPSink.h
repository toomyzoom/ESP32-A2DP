...
class BluetoothA2DPSink : public BluetoothA2DPCommon {
  ...
  public: 
    ...
    virtual void set_bps_callback(void (*callback)(uint8_t bit_depth)) {
      this->bps_callback = callback;
    }
    ...
    virtual void set_channels(i2s_channel_t channels) {
        volume_control()->set_mono_downmix(channels==I2S_CHANNEL_MONO);
    }
  ...
  protected:
    ...
    void (*bps_callback)(uint8_t bit_depth)=nullptr;
